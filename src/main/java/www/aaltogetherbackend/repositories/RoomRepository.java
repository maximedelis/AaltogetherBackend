...
public interface RoomRepository extends JpaRepository<Room, UUID> {
    ...
    @Query("SELECT r.id as id, r.name as name, r.code as code, r.aprivate as isPrivate, r.isFileSharingEnabled as isFileSharingEnabled, r.isChatEnabled as isChatEnabled, r.areCommandsEnabled as areCommandsEnabled, r.maxUsers as maxUsers, r.host.username as host, r.createdAt as createdAt FROM Room r WHERE r.aprivate = false")
    Set<RoomInfoInterface> findAllByAprivateFalse();

    @Query("SELECT r.id as id, r.name as name, r.code as code, r.aprivate as isPrivate, r.isFileSharingEnabled as isFileSharingEnabled, r.isChatEnabled as isChatEnabled, r.areCommandsEnabled as areCommandsEnabled, r.maxUsers as maxUsers, r.host.username as host, r.createdAt as createdAt FROM Room r WHERE r.host = :host")
    ...
    @Query("SELECT r.id as id, r.name as name, r.code as code, r.aprivate as isPrivate, r.isFileSharingEnabled as isFileSharingEnabled, r.isChatEnabled as isChatEnabled, r.areCommandsEnabled as areCommandsEnabled, r.maxUsers as maxUsers, r.host.username as host, r.createdAt as createdAt FROM Room r WHERE r.code = :code")
